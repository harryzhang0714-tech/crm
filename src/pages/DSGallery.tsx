...
const SOURCE = 'https://ds-gallery-e1q4.vercel.app/';
  ...
  return (
    <div className="p-6 h-full flex flex-col">
      <div className="flex items-center justify-between mb-4 flex-shrink-0">
        <div>
          <h1 className="text-xl font-bold text-white">Dropshipping 素材库</h1>
          <p className="text-gray-400 text-sm mt-0.5">风格A + 风格B 产品主图素材</p>
        </div>
      ...
      <div className="flex-1 rounded-2xl overflow-hidden border border-gray-800 bg-white">
        <iframe key={key} src={SOURCE} title="Dropshipping素材库" className="w-full h-full" style={{ border: 'none' }} />
      </div>
    </div>
  );
}